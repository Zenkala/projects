...
// constructor
logMenu::logMenu(const prog_char *prompt, const logMenu::command *commands, uint8_t entries, preprompt ppfunc) :
    _prompt(prompt),
    _commands(commands),
    _entries(entries),
    _ppfunc(ppfunc)
...
int8_t
logMenu::_call(uint8_t n, uint8_t argc)
{
    func fn;
